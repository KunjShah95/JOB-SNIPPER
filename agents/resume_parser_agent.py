...
class ResumeParserAgent(MultiAIAgent):
    ...
    def fallback_parsing(self, resume_text):
        ...
        try:
            ...
            parsed["skills"] = found_skills[:10]  # Limit to 10 skills
            ...
            for line in lines[:5]:  # Check first 5 lines
                ...
                if len(line) > 2 and len(line) < 50 and ' ' in line:
                    # Simple heuristic: if it contains 2-4 words and no numbers
                    words = line.split()
